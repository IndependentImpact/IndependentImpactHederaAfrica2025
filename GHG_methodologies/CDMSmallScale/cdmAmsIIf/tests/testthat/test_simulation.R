test_that("simulation generates expected columns", {
  set.seed(123)
  data <- simulate_ams_iif_dataset(n_facilities = 3, n_periods = 2, start_year = 2024, start_month = 6)
  expect_s3_class(data, "tbl_df")
  expected_cols <- c(
    "facility_id", "monitoring_period", "year", "month", "day", "monitoring_date",
    "monitoring_label", "baseline_electricity_mwh", "baseline_fuel_energy_gj",
    "baseline_electricity_emission_factor_tco2_per_mwh", "baseline_fuel_emission_factor_tco2_per_gj",
    "baseline_total_energy_mwh", "project_electricity_mwh", "project_fuel_energy_gj",
    "project_electricity_emission_factor_tco2_per_mwh", "project_fuel_emission_factor_tco2_per_gj",
...
test_that("aggregation collapses monitoring periods", {
  ...
  summary <- aggregate_monitoring_periods_iif(
    data,
