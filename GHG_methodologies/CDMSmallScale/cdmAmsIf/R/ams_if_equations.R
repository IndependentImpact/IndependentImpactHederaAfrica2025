#' Calculate baseline captive electricity (Equation 1)
#'
#' Implements Equation (1) of AMS-I.F by summing the electricity delivered to
...
#'
#' Applies Equation (2) of AMS-I.F by multiplying baseline captive electricity
#' by the baseline emission factor representing displaced fossil-based
...
#' backup generators that support the captive renewable system.
#'
...
#'
#' Implements Equation (4) of AMS-I.F by subtracting project emissions from
#' baseline emissions.
#'
