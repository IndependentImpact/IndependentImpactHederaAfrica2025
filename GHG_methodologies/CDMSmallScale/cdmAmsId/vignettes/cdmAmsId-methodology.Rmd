---
title: "AMS-I.D Methodology Walkthrough"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{AMS-I.D Methodology Walkthrough}
...
This vignette demonstrates how to reproduce the AMS-I.D calculations using `cdmAmsId`. The
...
check_applicability_baseline_fossil_share(baseline_fossil_share = 0.75)
```
