#' Simulate a dataset compliant with AMS-I.D
#'
#' Generates a tidy dataset representing electricity supplied by renewable
#' generation assets to a captive mini-grid. The simulation provides monitoring
#' metadata and emission outcomes compatible with the aggregation helpers.
#'
#' @param n_grids Number of mini-grids to simulate.
...
#'   electricity supply, and emissions.
#' @examples
#' simulate_ams_id_dataset(n_grids = 5)
#' @importFrom stats rnorm
#' @importFrom tibble as_tibble
#' @export
simulate_ams_id_dataset <- function(n_grids = 10,
                                     n_periods = 12,
                                     start_year = 2023,
                                     start_month = 1,
