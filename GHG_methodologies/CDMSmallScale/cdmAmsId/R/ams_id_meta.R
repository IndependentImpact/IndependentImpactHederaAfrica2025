#' Estimate emission reductions under AMS-I.D
#'
#' Composes the equation-level helpers to compute emission reductions for
#' datasets describing electricity supplied to a captive mini-grid and the
#' associated baseline emission factor.
#'
...
#' estimate_emission_reductions_ams_id(supply, baseline_emission_factor = 0.72)
#' @export
estimate_emission_reductions_ams_id <- function(supply_data,
...
#' consistency with AMS-I.D calculations.
#'
