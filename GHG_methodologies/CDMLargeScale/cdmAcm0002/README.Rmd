...
`cdmAcm0002` implements the Clean Development Mechanism (CDM) large-scale methodology
**ACM0002 Grid-connected electricity generation from renewable sources**. The
package follows tidyverse design principles and exposes applicability checks,
equation-level helpers, and meta-calculation wrappers to reproduce emission
reduction estimates for grid-connected renewable power plants.
